...
// how to generate a random number manually, but will be using library instead
...
function colorizeSliders(color, hue, brightness, saturation) {
  ...
  const fullSafull = color.set("hsl.s", 1);
  const scaleSat = chroma.scale([noSat, color, fullSafull]);
  //scale brightness
